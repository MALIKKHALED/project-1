...
def play_board(board):
    print("\t      |----------------------------|")
    print("\t      | " + board[0][0] + "  |  " + board[1][0] + "  |  " + board[2][0] + "  |  " + board[3][0] + "  |  " + board[4][0] + "  |")
    print("\t      |----------------------------|")
    print("\t      | " + board[0][1] + "  |  " + board[1][1] + "  |  " + board[2][1] + "  |  " + board[3][1] + "  |  " + board[4][1] + "  |")
    print("\t      |----------------------------|")
    print("\t      | " + board[0][2] + "  |  " + board[1][2] + "  |  " + board[2][2] + "  |  " + board[3][2] + "  |  " + board[4][2] + "  |")
    print("\t      |----------------------------|")
    print("\t      | " + board[0][3] + "  |  " + board[1][3] + "  |  " + board[2][3] + "  |  " + board[3][3] + "  |  " + board[4][3] + "  |")
    print("\t      |----------------------------|")
    print("\t      | " + board[0][4] + "  |  " + board[1][4] + "  |  " + board[2][4] + "  |  " + board[3][4] + "  |  " + board[4][4] + "  |")
    print("\t      |----------------------------|")
...
def take_player1_input(board):
    ...
    while True:
        while True:
            player1_row_play = input(" << Player1 : Enter a number 1 : 5 for row >> --> ")
            player1_column_play = input(" << Player1 : Enter a number 1 : 5 for column >> --> ")
            print("")
        ...
        if player1_row_play >= 1 and player1_row_play <= 5 \
                and player1_column_play >= 1 and player1_column_play <= 5 \
...
def take_player2_input(board):
    while True:
        while True:
            player2_row_play = input(" << Player2 : Enter a number 1 : 5 for row >> --> ")
            player2_column_play = input(" << Player2 : Enter a number 1 : 5 for column >> --> ")
            print("")
        ...
        if player2_row_play >= 1 and player2_row_play <= 5 \
                and player2_column_play >= 1 and player2_column_play <= 5 \
...
def player_check_win(player_column_play, player_row_play, board):
    ...
    if (player_column_play - 1) + 2 <= 4:
        if board[player_column_play - 1][player_row_play - 1] == "S" \
                and board[(player_column_play - 1) + 1][player_row_play - 1] == "O" \
                and board[(player_column_play - 1) + 2][player_row_play - 1] == "S":
            count += 1

    if (player_column_play - 1) + 1 <= 4 and (player_column_play - 1) - 1 >= 0:
    ...
    if (player_row_play - 1) + 2 <= 4:
        if board[player_column_play - 1][player_row_play - 1] == "S" \
                and board[player_column_play - 1][(player_row_play - 1) + 1] == "O" \
                and board[player_column_play - 1][(player_row_play - 1) + 2] == "S":
            count += 1

    if (player_row_play - 1) + 1 <= 4 and (player_row_play - 1) - 1 >= 0:
        if board[player_column_play - 1][player_row_play - 1] == "O" \
    ...
    if (player_column_play - 1) + 2 <= 4 and (player_row_play - 1) + 2 <= 4:
        if board[player_column_play - 1][player_row_play - 1] == "S" \
                and board[(player_column_play - 1) + 1][(player_row_play - 1) + 1] == "O" \
                and board[(player_column_play - 1) + 2][(player_row_play - 1) + 2] == "S":
            count += 1
    ...
    if (player_column_play - 1) - 1 >= 0 and (player_row_play - 1) - 1 >= 0 \
            and (player_column_play - 1) + 1 <= 4 and (player_row_play - 1) + 1 <= 4:
        if board[player_column_play - 1][player_row_play - 1] == "O" \
                and board[(player_column_play - 1) - 1][(player_row_play - 1) - 1] == "S" \
                and board[(player_column_play - 1) + 1][(player_row_play - 1) + 1] == "S":
            count += 1

    if (player_column_play - 1) + 2 <= 4 and (player_row_play - 1) - 2 >= 0:
        if board[player_column_play - 1][player_row_play - 1] == "S" \
                and board[(player_column_play - 1) + 1][(player_row_play - 1) - 1] == "O" \
                and board[(player_column_play - 1) + 2][(player_row_play - 1) - 2] == "S":
            count += 1

    if (player_column_play - 1) - 2 >= 0 and (player_row_play - 1) + 2 <= 4:
        if board[player_column_play - 1][player_row_play - 1] == "S" \
                and board[(player_column_play - 1) - 1][(player_row_play - 1) + 1] == "O" \
                and board[(player_column_play - 1) - 2][(player_row_play - 1) + 2] == "S":
            count += 1

    if (player_column_play - 1) + 1 <= 4 and (player_row_play - 1) - 1 >= 0 \
            and (player_column_play - 1) - 1 >= 0 and (player_row_play - 1) + 1 <= 4:
        if board[player_column_play - 1][player_row_play - 1] == "O" \
                and board[(player_column_play - 1) + 1][(player_row_play - 1) - 1] == "S" \
                and board[(player_column_play - 1) - 1][(player_row_play - 1) + 1] == "S":
            count += 1
